...
% ---------- Graphics ----------
\usepackage{graphicx}
\graphicspath{{./}{fig/}{../fig/}{figures/}{../figures/}{img/}{../img/}} % robust paths for compile from repo root or poster/
    ...
    \IfFileExists{#2}{%
      ...
      \IfFileExists{fig/#2}{%
        ...
        \IfFileExists{../fig/#2}{%
          ...
          \fbox{\parbox{0.9\linewidth}{\centering Missing image file: \texttt{\detokenize{#2}}}}%
        }%
      }%
    }\\[-3pt]
...
\posterfig[0.9\linewidth]{notif_frequency.png}{Notification frequency over time}
...
\block{Results}{
Performance is evaluated using standard ranking metrics for imbalanced classification. All metrics computed on the 2024–2025 test set, with 10,404 triples from 428 notifications. 
...
\posterfig[0.9\linewidth]{precision_recall_curve.png}{Precision-Recall curves by model on the 2024--2025 test set}
...
\posterfig[0.75\linewidth]{ranking_quality.png}{Precision@Top-10\% by model, with baseline rate for reference}
}
...
\posterfig[\linewidth]{io_1.png}{IO centrality and downstream dependence for high-risk vs. rest triples}
...
\textbf{Code and replication:} \href{https://github.com/dhhoang-vna/Predicting-U.S.-WTO-Notifications}{github.com/dhhoang-vna/Predicting-U.S.-WTO-Notifications}
